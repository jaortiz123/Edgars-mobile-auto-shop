 ...
 * Using JavaScript to avoid TypeScript compilation issues with .js imports
 */
...
describe('DateUtils Coverage Tests', () => {
  ...
  describe('Date Formatting', () => {
    ...
    it('should get relative date strings', () => {
      ...
      expect(dateUtils.getRelativeDate(yesterday)).toContain('Yesterday');
  ...
  describe('Date Arithmetic', () => {
    ...
    it('should calculate minutes difference', () => {
      ...
      // Test error handling
      expect(dateUtils.getMinutesDifference(null, date2)).toBe(0);
      expect(dateUtils.getMinutesDifference(date1, null)).toBe(0);
      expect(dateUtils.getMinutesDifference(new Date('invalid'), date2)).toBe(0);
    });
  });
  ...
  describe('Business Days', () => {
    it('should calculate business days between dates', () => {
      ...
      expect(businessDays).toBe(4); // Mon, Tue, Wed, Thu (excluding Friday as end date)
