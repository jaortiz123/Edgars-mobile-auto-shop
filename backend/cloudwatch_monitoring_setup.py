...
def create_monitoring_dashboard():
    ...
    try:
        ...
        print(
            f"Dashboard URL: https://console.aws.amazon.com/cloudwatch/home?region=us-east-1#dashboards:name={dashboard_name}"
        )
    ...
    alarms = [
        {
            ...
            "Statistic": "Sum",
            "Dimensions": [{"Name": "FunctionName", "Value": "reminder-function"}],
        ...
        },
        {
            ...
            "Namespace": "AWS/SNS",
            "Statistic": "Sum",
            "Dimensions": [{"Name": "TopicName", "Value": "edgar-sms-notifications"}],
            "Period": 300,
            "EvaluationPeriods": 1,
            "Threshold": 5.0,
            "ComparisonOperator": "GreaterThanThreshold",
        ...
        },
        {
            ...
            "Statistic": "Sum",
            "Dimensions": [{"Name": "TableName", "Value": "sms-notification-tracking"}],
            "Period": 300,
            "EvaluationPeriods": 1,
            "Threshold": 1.0,
                ...
                MetricData=[
                    {
                        ...
                        "Dimensions": [{"Name": "Status", "Value": "OptedIn"}],
                    ...
                    {
                        "MetricName": "SMSConsent",
                        "Dimensions": [{"Name": "Status", "Value": "OptedOut"}],
                ...
                MetricData=[
                    {
                        ...
                        "Dimensions": [{"Name": "Type", "Value": reminder_type}],
                        "Value": count,
                        "Unit": "Count",
                        "Timestamp": datetime.utcnow(),
                    }
...
if __name__ == "__main__":
    ...
    print("💡 Don't forget to subscribe to the alert SNS topic for notifications!")
