...
class TestNotificationFunction:
    ...
    def test_send_notification_confirmation(self, mock_sns):
        ...
        assert (
            call_args.kwargs["MessageAttributes"]["AWS.SNS.SMS.SenderID"]["StringValue"]
            == "Edgar Auto"
        )
        assert (
            call_args.kwargs["MessageAttributes"]["AWS.SNS.SMS.SMSType"]["StringValue"]
            == "Transactional"
        )
    ...
    def test_format_confirmation_message(self):
        ...
        message = format_confirmation_message("Test Customer", "2025-07-12T15:30:00", "Oil Change")
    ...
    def test_format_reminder_message(self):
        ...
        message = format_reminder_message("Test Customer", "2025-07-13T10:00:00", "Brake Check")
    ...
    def test_sns_error_handling(self, mock_sns):
        ...
        event = {"type": "appointment_confirmation", "customer_name": "Test User"}
