    ...
    try:
        ...
        if reminder_result['statusCode'] == 200:
            ...
            if body.get('appointments_found', 0) > 0:
                ...
                print("⚠️ No appointments found - this might be expected if appointment is not in 24-26 hour window")
        else:
...
if __name__ == "__main__":
    ...
    os.environ.setdefault('DB_SECRET_ARN', 'arn:aws:secretsmanager:us-east-1:123456789012:secret:test-secret')
