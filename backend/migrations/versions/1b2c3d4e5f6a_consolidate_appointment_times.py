...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(
        "appointments", sa.Column("scheduled_time", sa.TIME(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "appointments", sa.Column("scheduled_date", sa.DATE(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "appointments", sa.Column("end", sa.TIMESTAMP(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "appointments", sa.Column("start", sa.TIMESTAMP(), autoincrement=False, nullable=True)
    )
    op.drop_column("appointments", "end")
    op.drop_column("appointments", "start")
    # ### end Alembic commands ###
