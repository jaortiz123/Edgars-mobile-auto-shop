...
def upgrade():
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['replaced_by_id'], ['service_operations.id'], name='fk_service_operations_replaced_by'),
    )
    ...
    with op.batch_alter_table('appointments') as batch_op:
        ...
        batch_op.create_foreign_key('fk_appointments_primary_operation', 'service_operations', ['primary_operation_id'], ['id'])
