...
def lambda_handler(event, context):
    ...
    secret_value = secrets_client.get_secret_value(
        SecretId="arn:aws:secretsmanager:us-west-2:588738589514:secret:rds-db-credentials/cluster-TF5CDWLWGB2WFGPYETQWQRPJ4Q/postgres-7fZdgZ"
    )
    ...
    return {
        "statusCode": 200,
        "body": json.dumps(
            {"message": "Database initialized successfully!", "tables": [t[0] for t in tables]}
        ),
    }
