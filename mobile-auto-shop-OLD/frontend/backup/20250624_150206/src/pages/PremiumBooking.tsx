...
import { ArrowLeft, CheckCircle, Clock, MapPin, User, Phone, Mail, Calendar, MessageSquare, Wrench, Sparkles, Star, ArrowRight, Shield, Award, Timer, Calculator, Play, ChevronRight, Zap } from 'lucide-react';
import {
  serviceAPI,
  customerAPI,
  appointmentAPI,
